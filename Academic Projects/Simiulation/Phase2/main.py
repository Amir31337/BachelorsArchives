...
class Person:                               #for attribute and stats of each customer
    def __init__(self, index,arrival_time):
        ...
        if random.random() < 0.5:
            A2 = 1                          # may this customer choose call-back option
        else:
            A2 = 0
...
def starting_state(max_Experts = 2 , Beginner_mean_service_time = tt(min= 7) , max_Technician = 2): #inputs for sensitivity analysis
...
def arrival(future_event_list, state, clock, data, customer):
    ...
    if data['Customers'][customer].type == 1:                   #if a VIP customer calls
        ...
        if state['Busy Beginners']<3:                           #if we have idle Beginner
            data['Customers'][customer].service_start_time=clock
...
def simulation(simulation_time,max_Experts = 2 , Beginner_mean_service_time = tt(min= 7) , max_Technician = 2):
    seed = random.randint(0,1000000)
    random.seed(seed)

    state, future_event_list, data = starting_state(max_Experts, Beginner_mean_service_time  , max_Technician)
    clock = 0
    ...
    KPI['Queue stats']['average length'][1] = data['Cumulative Stats']['Area Under Queue1 Length Curve']/tt(month=1)
    KPI['Queue stats']['average length'][2] = data['Cumulative Stats']['Area Under Queue2 Length Curve']/tt(month=1)
    KPI['Queue stats']['average length'][3] = data['Cumulative Stats']['Area Under Queue3 Length Curve']/tt(month=1)
    KPI['Queue stats']['average length'][4] = data['Cumulative Stats']['Area Under Queue4 Length Curve']/tt(month=1)
    KPI['Queue stats']['average length'][5] = data['Cumulative Stats']['Area Under Queue5 Length Curve']/tt(month=1)
    KPI['Queue stats']['average length'][6] = data['Cumulative Stats']['Area Under Queue6 Length Curve']/tt(month=1)
    ...
    KPI['Efficiency']['Beginners'] = data['Cumulative Stats']['Beginner Busy Time'] / (tt(month=1)*3)
    KPI['Efficiency']['Experts'] = data['Cumulative Stats']['Expert Busy Time'] / (tt(month=1)*max_Experts)
    KPI['Efficiency']['Technician'] = data['Cumulative Stats']['Technician Busy Time'] / (tt(month=1)*max_Technician)
...
#its a run for 3 month and saves steps in output.xlsx
KPI , seed = simulation(tt(month=3),max_Experts = 2 , Beginner_mean_service_time = tt(min= 7) , max_Technician = 2)
#
...
#     for i in range(100):
#         print(i , s ,'Beginner')
#         KPI ,seed = simulation(tt(month=1),max_Experts = 2 , Beginner_mean_service_time = tt(min= s) , max_Technician = 2)
#         final['seed'].append(seed)
#         if i==0:
#             for key1 in KPI.keys():
#                 for key2 in KPI[key1].keys():
#                     if type(KPI[key1][key2]) == dict:
#                         for key3 in KPI[key1][key2].keys():
#                             final[str(key1) + ' ' + str(key2) + ' ' + str(key3)] = list()
#                     else:
#                         final[str(key1) + ' ' + str(key2)] = list()
#         for key1 in KPI.keys():
#             for key2 in KPI[key1].keys():
#                 if type(KPI[key1][key2]) == dict:
#                     for key3 in KPI[key1][key2].keys():
#                         final[str(key1) + ' ' + str(key2) + ' ' + str(key3)].append(KPI[key1][key2][key3])
#                 else:
#                     final[str(key1) + ' ' + str(key2)].append(KPI[key1][key2])
#     ss = pd.DataFrame(final)
#     ss.to_excel(f'Begginer mean service time{s}.xlsx')
#
#
# for s in range(1,6):
#     final = {'seed': list()}
#     for i in range(100):
#         print(i , s)
#         KPI ,seed = simulation(tt(month=1),max_Experts = s , Beginner_mean_service_time = tt(min= 7) , max_Technician = 2)
#         final['seed'].append(seed)
#         if i==0:
#             for key1 in KPI.keys():
#                 for key2 in KPI[key1].keys():
...
#                     final[str(key1) + ' ' + str(key2)].append(KPI[key1][key2])
#     ss = pd.DataFrame(final)
#     ss.to_excel(f'Expert{s}.xlsx')
#
# for s in range(1,6):
#     final = {'seed': list()}
#     for i in range(100):
#         print(i , s)
#         KPI ,seed = simulation(tt(month=1),max_Experts = 2 , Beginner_mean_service_time = tt(min= 7) , max_Technician = s)
#         final['seed'].append(seed)
#         if i==0:
#             for key1 in KPI.keys():
#                 for key2 in KPI[key1].keys():
...
#                     final[str(key1) + ' ' + str(key2)].append(KPI[key1][key2])
#     ss = pd.DataFrame(final)
#     ss.to_excel(f'Technician{s}.xlsx')

# run for confidence interval

# final = {'seed': list()}
# for i in range(100):
#     KPI ,seed = simulation(tt(month=1),max_Experts = 2 , Beginner_mean_service_time = tt(min= 7) , max_Technician = 2)
#     final['seed'].append(seed)
#     if i==0:
#         for key1 in KPI.keys():
#             for key2 in KPI[key1].keys():

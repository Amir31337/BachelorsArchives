...
# KPI , seed = simulation(tt(month=1) ,Expert_mean_service_time = tt(min= 3), Beginner_mean_service_time = tt(min= 7),max_Experts = 2 , max_Technician = 2 , max_Beginner =3)
#
...
#     for i in range(100):
#         print(i , s ,'Beginner')
#         KPI ,seed = simulation(tt(month=1) ,Expert_mean_service_time = tt(min= 3), Beginner_mean_service_time = tt(min= s) ,max_Experts = 2, max_Technician = 2 , max_Beginner = 3)
...
#     for i in range(100):
#         print(i , s)
#         KPI ,seed = simulation(tt(month=1) ,Expert_mean_service_time = tt(min= 3), Beginner_mean_service_time = tt(min= 7),max_Experts = s , max_Technician = 2 , max_Beginner = 3)
#         final['seed'].append(seed)
#         if i==0:
#             for key1 in KPI.keys():
#                 for key2 in KPI[key1].keys():
...
#     for i in range(100):
#         print(i , s)
#         KPI ,seed = simulation(tt(month=1) ,Expert_mean_service_time = tt(min= 3), Beginner_mean_service_time = tt(min= 7) ,max_Experts = 2, max_Technician = s , max_Beginner = 3)
#         final['seed'].append(seed)
#         if i==0:
#             for key1 in KPI.keys():
#                 for key2 in KPI[key1].keys():

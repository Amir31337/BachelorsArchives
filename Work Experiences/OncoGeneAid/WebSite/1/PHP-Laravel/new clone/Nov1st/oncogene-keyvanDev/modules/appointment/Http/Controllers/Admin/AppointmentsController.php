...
use Modules\appointment\Http\Requests\MassDestroyAppointmentRequest;
use Modules\appointment\Http\Requests\StoreAppointmentRequest;
use Gate;
use Illuminate\Http\Request;
use Modules\appointment\Models\Appointment;
use Modules\appointment\Models\Client;
use Modules\appointment\Models\Employee;
use Modules\appointment\Models\Service;
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $table->editColumn('actions', function ($row) {
                ...
                $trash_appointment_count = Appointment::onlyTrashed()->count();
                return view('appointment::partials.datatablesActions', compact(
                    'viewGate',
                    'editGate',
                    'deleteGate',
                    'crudRoutePart',
                    'row',
                    'trash_appointment_count'
                ));
            });
        ...
        return Cview('appointment::admin.appointments.index', compact(['trash_appointment_count']));
    }

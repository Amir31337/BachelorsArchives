  ...
  mounted: function mounted() {
    ...
    if (this.filters.length === 0) {
      ...
      for (var i = 0; i < this.filters.length; i++) {
        this.fields = Object.assign(this.fields, _defineProperty({}, i + "_" + this.filters[i]['id'], this.filters[i]['title']));
        ...
        for (var j = 0; j < this.filters[i]['get_child'].length; j++) {
          ...
          var show_item = this.filters[i]['get_child'][j]['show_item'];

          if (this.childField[this.filters[i]['id']] === undefined) {
            this.childField = Object.assign(this.childField, _defineProperty({}, this.filters[i]['id'], _defineProperty({}, i + "_" + id, value)));
          } else {
            var newData = Object.assign(this.childField[this.filters[i]['id']], _defineProperty({}, i + "_" + id, value));
            this.childField[this.filters[i]['id']] = newData;
          }
        }
      }
    }
    ...
    this.$forceUpdate();
    this.$root.$on('complete_data', function (key, value, dataName) {

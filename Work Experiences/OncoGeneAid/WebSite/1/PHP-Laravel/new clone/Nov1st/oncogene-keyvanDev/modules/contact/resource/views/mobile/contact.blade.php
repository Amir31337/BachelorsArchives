            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control nameAndFamily" id="nameAndFamily">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control messageText" id="messageText" rows="3"></textarea>
                    </div>
                    <div class="form-group">
                        <button type="button" class="btn btn-outline-success">ارسال</button>
                    </div>
                </form>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">

...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      tabs: ['در انتظار پرداخت', 'در حال پردازش', 'تحویل شده', 'مرجوعی', 'لغو شده'],
      tabId: ['wait_for_payment', 'paid_in_progress', 'delivered', 'returned', 'canceled'],
      orderList: {},
      sendRequest: {},
      pages: {}
    };
  },
  props: ['orders', 'shop_product_url', 'order_count'],
  mounted: function mounted() {
  ...
  methods: {
    ...
    getTabOrder: function getTabOrder(key) {
      ...
      if (this.orderList[this.tabId[key]] === undefined) {
        ...
        var type = this.tabId[key].toString().replaceAll('_', '-');
                  ...
                  _c(
                    ...
                    [
                      _c("img", {
                        ...
                        attrs: {
                          src:
                            _vm.$siteUrl + "/files/images/step" + key + ".svg",
                        },
                      }),
                      _vm._v(" "),
        ...
        _vm._l(_vm.tabs, function (title, key) {
          return _c(
            ...
            [
              ...
              _vm._v(" "),
              _vm.order_count[_vm.tabId[key]] > 0
                ? _c("span", { staticClass: "count" }, [
                    _vm._v(
                      _vm._s(_vm.replaceNumber(_vm.order_count[_vm.tabId[key]]))
                    ),
                  ])
                : _vm._e(),
            ]
        ...
        : _c("div", [
            ...
            _vm.orderList[_vm.tabId[_vm.tab]]["data"].length > 0
              ? _c(
                  ...
                  [
                    _vm._l(
                      _vm.orderList[_vm.tabId[_vm.tab]]["data"],
                      function (order) {
                        return _c(
                          "div",

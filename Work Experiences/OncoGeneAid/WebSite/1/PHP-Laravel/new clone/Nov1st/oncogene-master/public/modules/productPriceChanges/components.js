        ...
        tooltip: {
          ...
          formatter: function formatter() {
            if (this.point.has_product == "ok") {
              return '<div>' + '<ul class="chart_ul">' + '<li style="justify-content: end;margin-top: 10px">' + '<span style="padding-right: 4px">' + this.point.seller + '</span> : <span>فروشنده</span>' + '</li>' + '<li style="justify-content: space-between;margin-top: 15px">' + '<div style="color:#1457c5;font-size:19px;direction: rtl"><span>' + replaceNumber(number_format(this.point.price)) + '</span> <span>تومان</span></div>' + '<div>کمترین قیمت</div>' + '</li>' + '</ul>' + '</div>';
            } else {
              return '<div>' + '<ul class="chart_ul">' + '<li style="justify-content: space-between;margin-top: 15px">' + '<div style="color:#1457c5;font-size:19px;direction: rtl"><span>ناموجود</span></div>' + '<div>کمترین قیمت</div>' + '</li>' + '</ul>' + '</div>';
            }
          }
        }
      },
    ...
    return {
      ...
      chartOptions: {
        ...
        tooltip: {
          ...
          formatter: function formatter() {
            if (this.point.has_product == "ok") {
              return '<div>' + '<ul class="chart_ul">' + '<li style="justify-content: end;margin-top: 10px">' + '<span style="padding-right: 4px">' + this.point.seller + '</span> : <span>فروشنده</span>' + '</li>' + '<li style="justify-content: space-between;margin-top: 15px">' + '<div style="color:#1457c5;font-size:19px;direction: rtl"><span>' + self.replaceNumber(self.number_format(this.point.price)) + '</span> <span>تومان</span></div>' + '<div>کمترین قیمت</div>' + '</li>' + '</ul>' + '</div>';
            } else {
              return '<div>' + '<ul class="chart_ul">' + '<li style="justify-content: space-between;margin-top: 15px">' + '<div style="color:#1457c5;font-size:19px;direction: rtl"><span>ناموجود</span></div>' + '<div>کمترین قیمت</div>' + '</li>' + '</ul>' + '</div>';
            }
          }

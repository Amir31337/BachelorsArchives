...
@section('content')
    <div>
        @include('backend-theme::breadcrumb',['data'=>[
             ['title'=>'مدیریت قرارملاقات ها','url'=>url('admin/appointments')],
        ]])

        <?php
        $args=[];
        $args['title']='مدیریت قرارملاقات ها';
        $args['route']='admin/appointments';
        $args['trashCount']=$trash_appointment_count;
        $args['routeParam']='قرارملاقات';
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('appointments.massDestroy') }}",

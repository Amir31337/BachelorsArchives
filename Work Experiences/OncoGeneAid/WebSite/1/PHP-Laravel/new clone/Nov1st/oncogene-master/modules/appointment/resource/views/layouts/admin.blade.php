...
<script src="{{asset('js/all/coreui.min.js')}}"></script>
<script src="{{asset('js/admin/jquery.dataTables.min.js')}}"></script>
<script src="{{asset('js/all/dataTables.bootstrap4.min.js')}}"></script>
...
<script src="{{asset('js/all/moment.min.js')}}"></script>
<script src="{{asset('js/all/bootstrap-datetimepicker.min.js')}}"></script>
<script src="{{asset('js/all/select2.full.min.js')}}"></script>
<script src="{{asset('js/all/dropzone.min.js')}}"></script>
